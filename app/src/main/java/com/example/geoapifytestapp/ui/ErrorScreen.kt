...
import com.example.geoapifytestapp.ui.theme.Gray100
import com.example.geoapifytestapp.ui.theme.Gray600
import com.example.geoapifytestapp.ui.theme.Teal100
import com.example.geoapifytestapp.utils.ConnectionState
import com.example.geoapifytestapp.utils.connectivityState
...
fun ErrorScreen(errorText: String, reloadAction: () -> Unit) {
    ...
    val titleText =
        if (isConnected) errorText else resources.getString(R.string.noInternetConnection)
    val descriptionText =
